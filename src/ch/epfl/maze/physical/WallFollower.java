...
abstract public class WallFollower extends Animal {
     ...
     * @setOrientation(The direction to follow in order to keep the animal's
     *                     hand on the left wall
     */
    ...
    /**
     * Computes the new orientation according to the current orientation of the
     * animal in the maze and the direction it just took
     * 
     * @param choice
