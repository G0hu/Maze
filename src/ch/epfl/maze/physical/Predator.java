...
abstract public class Predator extends Animal {
    ...
    /**
     * Computes the mode in which should be the predator, and increments the countMode if needed
     * (depends on the predator's strategy)
     * 
     * @return The current mode of the predator
     */
    
    abstract public int computeMode();
