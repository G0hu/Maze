...
public class DaedalusTest extends TestCase {
    ...
    private final static int[][] LABYRINTH = { { 1, 1, 1, 1, 1 },
            { 1, 0, 0, 0, 1 }, { 1, 1, 1, 1, 1 } };
    ...
    public void testGeneral() {
        ...
        assertTrue("Initial maze should NOT have animals in it", daedalus
                .getAnimals().size() == 0);
        ...
        assertTrue("Daedalus Predators should contain one Predator", daedalus
                .getPredators().size() == 1);
        assertTrue("Daedalus Preys should contain one Prey", daedalus
                .getPreys().size() == 1);
        ...
        assertTrue(
                "Predator inside the Daedalus should be the same as Predator added",
        ...
        assertFalse("Daedalus should NOT contain PacMan anymore",
                daedalus.hasPrey(dummyPrey));
        assertTrue("Daedalus should NOT have anymore Predator in it", daedalus
                .getPredators().size() == 0);
        assertTrue("Daedalus should NOT have anymore Prey in it", daedalus
                .getPreys().size() == 0);
        assertTrue("Daedalus should NOT have anymore Animal in it", daedalus
                .getAnimals().size() == 0);
        assertTrue("Daedalus without any animal should be solved",
                daedalus.isSolved());
    }
    ...
    public void testReset() {
        ...
        assertFalse("Daedalus should NOT be solved anymore",
                daedalus.isSolved());
        assertTrue("Daedalus should contain Blinky again", daedalus
                .getPredators().size() == 1);
        assertTrue("Daedalus should contain PacMan again", daedalus.getPreys()
                .size() == 1);
        assertTrue("Daedalus should contain Blinky and PacMan again", daedalus
                .getAnimals().size() == 2);
        ...
        assertTrue("Animals in Daedalus should be not null",
                retrievedPred != null);
        assertTrue("Animals in Daedalus should be not null",
                retrievedPrey != null);
    }
