...
public class MazeTest extends TestCase {
    ...
    private final static int[][] LABYRINTH = { { 1, 1, 1, 3, 1 },
            { 1, 0, 0, 0, 1 }, { 1, 2, 1, 1, 1 } };
    ...
    public void testGeneral() {
        ...
        assertTrue("Initial maze should NOT have animals in it", maze
                .getAnimals().size() == 0);
        ...
        assertTrue("Maze Animals should contain one Animal", maze.getAnimals()
                .size() == 1);
        ...
        assertTrue("Mouse inside the Maze should be the same as Mouse added",
                retrieved == dummy);
        assertFalse(
                "Maze with one Mouse even at the exit should NOT be solved",
                maze.isSolved());
        ...
        assertFalse("Maze should NOT contain the Mouse anymore",
                maze.hasAnimal(dummy));
        assertTrue("Maze should NOT have anymore Animal in it", maze
                .getAnimals().size() == 0);
    ...
    public void testReset() {
        ...
        assertTrue("Maze should contain the Mouse again", maze.getAnimals()
                .size() == 1);
