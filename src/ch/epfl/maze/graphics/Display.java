...
public final class Display implements Runnable {
    ...
    public Display(Simulation simulation) {
        ...
        if (simulation.getWorld() == null) {
            throw new IllegalArgumentException(
                    "World in Simulation must be defined.");
        }
        ...
        try {
            ...
            mTiles.put(World.START,
                    ImageIO.read(new File("img/tiles/start.png")));
            mTiles.put(World.EXIT, ImageIO.read(new File("img/tiles/exit.png")));
            mTiles.put(World.NOTHING,
                    ImageIO.read(new File("img/tiles/nothing.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void createMenu() {
        ...
        debugItem
                .setToolTipText("Enters in debug mode, allowing to move animals step by step.");
        menu.add(debugItem);
        ...
        accelerateItem
                .setToolTipText("Increases simulation speed up to a maximum.");
        decelerateItem
                .setToolTipText("Decreases simulation speed down to a minimum.");
