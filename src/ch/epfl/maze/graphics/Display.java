...
public final class Display implements Runnable {
	...
	// "Pause"
	final JMenuItem pauseItem = new JMenuItem(mDebug ? "Next step" : (mPaused ? "Resume" : "Pause"), KeyEvent.VK_P);
	...
	// "Accelerate"
	final JMenuItem accelerateItem = new JMenuItem("Accelerate", KeyEvent.VK_A);
	// "Decelerate"
	final JMenuItem decelerateItem = new JMenuItem("Decelerate", KeyEvent.VK_D);
